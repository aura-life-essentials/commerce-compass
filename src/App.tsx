...
const AppContent = () => {
  return (
    <>
      ...
      {/* Organic launch dashboard (per launch) */}
      <Route path="/launch/:id" element={<LaunchDashboard />} />

      {/* Public SEO landing pages generated by the launch engine */}
      <Route path="/l/:slug" element={<SeoLandingPage />} />

      {/* Launch governance: per-channel consents + AI audit log */}
