        ...
        <main className="container mx-auto px-6 py-8">
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              <Badge variant="outline" className="ml-auto border-cyan-500 text-cyan-400 px-4 py-1.5 text-sm">
                <span className="w-2 h-2 bg-cyan-500 rounded-full mr-2 animate-pulse inline-block" />
                Swarm Active
              </Badge>
            </div>
          </motion.div>
        ...
        <footer className="border-t border-border mt-12">
          <div className="container mx-auto px-6 py-6">
            <p className="text-center text-sm text-muted-foreground">
              Bot Swarm • 200-Agent Fleet Command
            </p>
          </div>
        </footer>
      </div>
