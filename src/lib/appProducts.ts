...
export const APP_PRODUCTS: AppProduct[] = [
  ...
  },
  {
    ...
    price: 1200,
    priceId: 'price_1TDxItFpvr5YnJS7EAe6ihpy',
    productId: 'prod_UCM0DT6Oy4PHgS',
    category: 'ai-agents',
    icon: 'Users',
  ...
  },
  {
    ...
    price: 3600,
    priceId: 'price_1TDxItFpvr5YnJS7OmEpU2rh',
    productId: 'prod_UCM0vcLbSZLI2Y',
    category: 'ai-agents',
    icon: 'Zap',
  ...
  },
  {
    ...
    price: 360,
    priceId: 'price_1TDxIvFpvr5YnJS7DA1Te2J2',
    productId: 'prod_UCM0SvE7eVwiYl',
    category: 'e-commerce',
    icon: 'ShoppingCart',
  ...
  },
  {
    ...
    price: 600,
    priceId: 'price_1TDxIxFpvr5YnJS73z06hPko',
    productId: 'prod_UCM0KwNLiOK8gA',
    category: 'web3',
    icon: 'Globe',
  ...
  },
  {
    ...
    price: 430,
    priceId: 'price_1TDxIyFpvr5YnJS7ZNxwvvaE',
    productId: 'prod_UCM1lSF2DjGe5g',
    category: 'media',
    icon: 'Video',
