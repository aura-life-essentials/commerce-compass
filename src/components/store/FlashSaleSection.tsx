        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-orange-300/80">Up to 70% off - Limited time only!</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {products.slice(0, 4).map((product, index) => {
              const stockSold = Math.floor(Math.random() * 80) + 20;
                    ...
                    <div className="p-4 space-y-3">
                      ...
                      <div className="space-y-1">
                        <div className="flex justify-between text-xs">
                          <span className="text-orange-300">Sold: {stockSold}%</span>
                          <span className="text-slate-400">Available: {100 - stockSold}%</span>
                        </div>
                        <Progress value={stockSold} className="h-2 bg-slate-700" />
                      </div>
