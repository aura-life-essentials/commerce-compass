...
import { Sparkles, Zap, Play, Star, ArrowRight } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <Button size="lg" variant="outline" className="border-slate-700 text-white hover:bg-slate-800 h-14 px-8 text-lg">
            ...
            >
              <div className="flex -space-x-3">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div
                    key={i}
                    className="w-10 h-10 rounded-full bg-gradient-to-br from-slate-700 to-slate-800 border-2 border-background flex items-center justify-center text-xs font-medium"
                  >
              ...
              <div>
                <p className="text-white font-semibold">50,000+ Happy Customers</p>
                <p className="text-sm text-slate-400">Join our community today</p>
              </div>
            </motion.div>
          </motion.div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400">2,847 reviews</p>
                  </div>
                </div>
              </motion.div>
